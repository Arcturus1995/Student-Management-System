@include('partials.header')
    ...
    <section class="mt-10">
        <div class="overflow-x-auto relative">
                ...
                <tbody>
                    @foreach ($students as $student)
                        <tr  class="bg-gray-800 border-b text-white">
                            ...
                            @endphp
                            <td>
                                <img class="w-[50px] h-[50px] object-cover" src="{{$student->student_image ? asset("storage/student/thumbnail/".$student->student_image) : $default_profile}}" alt="">
                            </td>
            ...
            <div class="pt-6 p-4 mx-auto max-w-lg">
                {{$students->links()}}
            </div>
        </div>
    </section>
