    ...
    <main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">Sign in your account 
                <a href="/login" class="text-blue-700 font-bold">Here</a>
            </p>
        ...
        <section class="mt-10">
            <form action="/store" method="POST" class="flex flex-col">
                ...
                <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:xl transition duration-200" type="submit" name="submit">Sign up</button>
            </form>
        </section>
    </main>
